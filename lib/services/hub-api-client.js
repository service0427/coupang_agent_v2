    ...
    try {
      const payload = {
        ...
        result: {
          ...
          // 상세 실행 상태 정보 전달
          execution_status: resultData.result.executionStatus || null,
          error_message: resultData.result.errorMessage || null,
          error_details: resultData.result.errorDetails || null,
          success_level: resultData.result.successLevel || null,
          blocked_reason: resultData.result.blockedReason || null,
          timeout_reason: resultData.result.timeoutReason || null
        },
        // 유연한 상품 데이터 JSON 구조
