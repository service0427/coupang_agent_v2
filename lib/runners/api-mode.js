...
const { calculateWindowPosition, setTotalThreadCount, initializeScreenResolution } = require('../utils/window-position');
...
class ApiModeRunner {
  ...
  async executeWork(workAllocation, threadIndex) {
    ...
    try {
      ...
      const { calculateViewportSize } = require('../utils/window-position');
