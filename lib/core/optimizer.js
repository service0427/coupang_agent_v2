        ...
        if (postData) {
          try {
            ...
            if (eventName === 'click_search_product' &&
              ...
              console.log(`🎯 [Akamai] click_search_product memberSrl 주입: ${sessionMemberSrl}`);
            }

            // Akamai 이벤트 로그 생략 (너무 많음)
