 ...
 */
async function launchChrome(proxy = null, persistent = false, profileName = null, clearSession = false, clearCache = false, headless = false, gpuDisabled = false, windowPosition = null, trafficMonitor = false, customUserDataDir = null) {
  let browser;
  let page;
  let context;
