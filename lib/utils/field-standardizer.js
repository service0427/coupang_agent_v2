...
function standardizeLaunchOptions(options) {
  ...
  return {
    ...
    profileName: options.profileName || options.profile_name || options.agent,
    clearSession: options.session !== undefined ? !options.session : options.clear_session === true,
    clearCache: options.cache !== undefined ? !options.cache : options.clear_cache === true,
...
function standardizeSearchOptions(options) {
  ...
  return {
    ...
    maxPages: options.maxPages || options.max_pages || 10,
    ...
    trafficDetail: options.trafficDetail || options.traffic_detail || false,
...
function convertToV2Format(standardData) {
  ...
  return {
    ...
    clear_cache: !standardData.cache,
