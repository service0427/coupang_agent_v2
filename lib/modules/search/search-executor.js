      ...
      if (targetProduct) {
        ...
        if (options.workType === 'rank') {
          ...
          try {
            ...
            const clickResult = await clickProduct(page, targetProduct, productCode, pageNum, products.length, options.keywordId, threadPrefix, products, options.workType, allocationKey);
              ...
              if (expandedTarget) {
                ...
                if (options.workType === 'rank') {
                  ...
                  try {
                    ...
                    const clickResult = await clickProduct(page, expandedTarget, productCode, pageNum, products.length, options.keywordId, threadPrefix, products, options.workType, allocationKey2);
